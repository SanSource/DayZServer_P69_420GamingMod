...
//Custom Manual FSM
[] execVM "\dz\420Mods\PVP_scripts_coastal\server\scripts\functions\fnc_ManualBrain.sqf";

//Custom feed
[] execVM "\dz\420Mods\PVP_scripts_coastal\server\scripts\events\killed_event.sqf";
...
event_assessDamage = 	compile preprocessFileLineNumbers "\dz\420Mods\PVP_scripts_coastal\server\scripts\events\event_assessDamage.sqf";
...
//event_playerKilled = 	compile preprocessFileLineNumbers "\dz\420Mods\PVP_scripts_coastal\server\scripts\events\event_playerKilled.sqf";
...
event_killedWildAnimal = compile preprocessFileLineNumbers "\dz\420Mods\PVP_scripts_coastal\server\scripts\events\event_killedWildAnimal.sqf";
event_killedZombie = compile preprocessFileLineNumbers "\dz\420Mods\PVP_scripts_coastal\server\scripts\events\event_killedZombie.sqf";
...
dbLoadPlayer = 			compile preprocessFileLineNumbers "\dz\420Mods\PVP_scripts_coastal\server\scripts\functions\dbLoadPlayer.sqf";
...
player_initialize = 	compile preprocessFileLineNumbers "\dz\420Mods\PVP_scripts_coastal\server\scripts\init\player_initialize.sqf";
...
//	_agent synchronizeVariable ["UID",3];
	...
	[_id] spawn FNC_DZ_ClientBrain; // Modded Brain
...
medical_playerBandage =
{
	...
	if (_this select 0) then
	{
		...
		_bldreg = _agent getVariable ["blood","0"];
        _regenblood = _bldreg + 950;
	    _agent setVariable ["blood",_regenblood];
