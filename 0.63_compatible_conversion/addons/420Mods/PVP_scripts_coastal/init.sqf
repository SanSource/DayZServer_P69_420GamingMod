...
//medical defines
DZ_BLOOD_UNCONSCIOUS = 5;	//minimum blood before player becomes unconscious
...
{
	diag_log "Start 1!";
	call compile preprocessFileLineNumbers "\dz\420Mods\PVP_scripts_coastal\server\scripts\init.sqf";
};
