...
switch _state do 
{
	...
	case 0:
	{
		...
		if ((vehicle _person) distance [10060.891, 5436.0332] < 500)
		exitWith{
			[_person, "I can not dig a plot here, too close to the safezone!", "colorImportant"] call fnc_playerMessage;
		};

		if ((vehicle _person) distance [2314.9932, 9617.6377] < 500)
		exitWith{
			[_person, "I can not dig a plot here, too close to a trader!", "colorImportant"] call fnc_playerMessage;
		};

		if ((vehicle _person) distance [6359.7725, 7760.9819] < 500)
		exitWith{
			[_person, "I can not dig a plot here, too close to a trader!", "colorImportant"] call fnc_playerMessage;
		};
		...
		diag_log format ['GardenPlot:::Lock::: %1', _person getSlotLock 'Hands'];
	...
	case 1:
	{
		...
		diag_log format ['GardenPlot:::Lock::: %1', _user getSlotLock 'Hands'];
