...
if (DZ_TradersActive) then { event_weaponFired = compile preprocessFileLineNumbers "\dz\420Mods\PVE_scripts\scripts\events\event_weaponFired.sqf"; } else {
...
event_assessDamage = 	compile preprocessFileLineNumbers "\dz\420Mods\PVE_scripts\scripts\events\event_assessDamage.sqf";
...
//event_playerKilled = 	compile preprocessFileLineNumbers "\dz\420Mods\PVE_scripts\scripts\events\event_playerKilled.sqf";
...
dbLoadPlayer = 			compile preprocessFileLineNumbers "\dz\420Mods\PVE_scripts\scripts\functions\dbLoadPlayer.sqf";
dbSavePlayerPrep = compile preprocessFileLineNumbers "\dz\420Mods\PVE_scripts\scripts\functions\dbSavePlayerPrep.sqf";
dbSavePlayer = compile preprocessFileLineNumbers "\dz\420Mods\PVE_scripts\scripts\functions\dbSavePlayer.sqf";
player_initialize = 	compile preprocessFileLineNumbers "\dz\420Mods\PVE_scripts\scripts\functions\player_initialize.sqf";
fnc_reloadWeaponOnSpawn = compile preprocessFileLineNumbers "\dz\420Mods\PVE_scripts\scripts\functions\fnc_reloadWeaponOnSpawn.sqf";
fnc_addHandsItem = compile preprocessFileLineNumbers "\dz\420Mods\PVE_scripts\scripts\functions\fnc_addHandsItem.sqf";
fnc_addQuickBarItems = compile preprocessFileLineNumbers "\dz\420Mods\PVE_scripts\scripts\functions\fnc_addQuickBarItems.sqf";
fnc_addItemState = compile preprocessFileLineNumbers "\dz\420Mods\PVE_scripts\scripts\functions\fnc_addItemState.sqf";
fnc_getItemState = compile preprocessFileLineNumbers "\dz\420Mods\PVE_scripts\scripts\functions\fnc_getItemState.sqf";
fnc_getInvItems = compile preprocessFileLineNumbers "\dz\420Mods\PVE_scripts\scripts\functions\fnc_getInvItems.sqf";
fnc_addInvItems = compile preprocessFileLineNumbers "\dz\420Mods\PVE_scripts\scripts\functions\fnc_addInvItems.sqf";
fnc_dbDestroyProfile = compile preprocessFileLineNumbers "\dz\420Mods\PVE_scripts\scripts\functions\fnc_dbDestroyProfile.sqf";
fnc_dbFindInProfile = compile preprocessFileLineNumbers "\dz\420Mods\PVE_scripts\scripts\functions\fnc_dbFindInProfile.sqf";
fnc_dbLoadFromProfile = compile preprocessFileLineNumbers "\dz\420Mods\PVE_scripts\scripts\functions\fnc_dbLoadFromProfile.sqf";
fnc_dbSaveToProfile = compile preprocessFileLineNumbers "\dz\420Mods\PVE_scripts\scripts\functions\fnc_dbSaveToProfile.sqf";
fnc_dbCreateCharInProfile = compile preprocessFileLineNumbers "\dz\420Mods\PVE_scripts\scripts\functions\fnc_dbCreateCharInProfile.sqf";
...
if (DZ_TradersActive) then { player_digGreenhouse =	compile preprocessFileLineNumbers "\dz\420Mods\PVE_scripts\scripts\events\player_digGreenhouse.sqf"; }else{
...
if (DZ_TradersActive) then { player_DigGardenPlot = compile preprocessFileLineNumbers "\dz\420Mods\PVE_scripts\scripts\events\player_DigGardenPlot.sqf"; }else{
...
while {true} do {
	...
	if ( (typeOf _agent == "SurvivorPartsFemaleAfrican") ) then {
		//diag_log format["FIX FIX FIX"];
	} else {
	if ((lifeState _agent == "ALIVE")) then {
	if (vehicle _x == _x) then {
	[1,_uid,_agent] call dbSavePlayer;
	diag_log format["Saved Player: [%1] [%2]",_uid,(name _x)];
	} else { diag_log format["Player NOT SAVED! CURRENTLY IN A VEHICLE!: [%1] [%2]",_uid,(name _x)]; };
	} else { [0,_uid,_agent] call dbSavePlayer; diag_log format["Saved Player as DEAD: [%1] [%2]",_uid,(name _x)]; };
	};
	}forEach players;
	sleep 50;
	};
